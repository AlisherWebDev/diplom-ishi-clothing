<template>
  <FadeTransition>
    <BaseCard>
      <BaseHeading variant="h2">Sizning ma'lumotlaringiz</BaseHeading>
...
const validateForm = () => {
  ...
  if (!isNameInputValid || !isPhoneValid) {
    formError.name = isNameInputValid
      ? ""
      : "Ismingiz 3ta harfdan kam bo'masligi kerak";
    (formError.phone = isPhoneValid
      ? ""
      : "Telefon raqamingiz 10-20ta raqamdan iborat bo'lishi lozim"),
      (isFormValid = false);
  }
