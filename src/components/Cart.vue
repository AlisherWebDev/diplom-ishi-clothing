  ...
  <section class="cart">
    <div class="cart__mobile">
      <div class="cart__grid">
        <label class="cart__title">Rasm</label>
        <label class="cart__title">Ma'lumot</label>
        <label class="cart__title">Miqdori</label>
        <label class="cart__title">Narxi</label>
        <label class="cart__title">jami </label>
      </div>
    </div>
    ...
    <div class="cart__totals-block">
      <span class="cart__totals-block-title">Mahsulot Miqdori:</span>
      <p>{{ totalProductsAddedToCart }} ta</p>
    </div>
    <div class="cart__totals-block">
      <span class="cart__totals-block-title">Umumiy hisob: </span>
      <p>${{ totalAmount }}</p>
    </div>
    ...
    <div class="cart__totals-block" v-if="delivery && delivery.name">
      <span class="cart__totals-block-title">Jami:</span>
      <p>${{ total }}</p>
    </div>
  </section>
</template>
