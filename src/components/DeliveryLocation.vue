<template>
  <div class="delivery-location">
    <BaseHeading variant="h3" v-if="isLocationVisible">
      <span class="delivery-location__title">Sizning Joylashuvingiz:</span>
      {{ location }}
    </BaseHeading>
    <div v-if="!isSelected" class="delivery-location__confirm-block">
      <BaseHeading variant="h3">Joylashuvingiz to'g'rimi?</BaseHeading>
      <div class="delivery-location__actions">
        <BaseButton variant="outlined" @click="confirm(false)">Yo'q</BaseButton>
...
const MESSAGE_SUCCESS =
  "Rahmat. Sizning mintaqangiz avtomatik ravishda o'rnatiladi";
const MESSAGE_FAIL =
  "Kechirasiz. Quyidagi shaklda yetkazib berish hududingizni qo‘lda kiriting";
